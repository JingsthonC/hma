...
export async function action({ request }) {
  try {
    ...
    const newStaff = Object.fromEntries(formData);
    const data = new FormData();
    data.append("staff_first_name", newStaff.staff_first_name);
    data.append("staff_middle_name", newStaff.staff_middle_name);
    data.append("staff_last_name", newStaff.staff_last_name);
    data.append("staff_name_ext", newStaff.staff_name_ext);
    data.append("staff_email", newStaff.staff_email);
    data.append("staff_contact_number", newStaff.staff_contact_number);
    data.append("staff_address_street", newStaff.staff_address_street);
    data.append("staff_address_city", newStaff.staff_address_city);
    data.append("staff_address_province", newStaff.staff_address_province);
    data.append("staff_address_zip_code", newStaff.staff_address_zip_code);
    data.append("staff_birthday", newStaff.staff_birthday);
    data.append("staff_position", newStaff.staff_position);
    data.append("staff_password", newStaff.staff_password);
    data.append("staff_employment_status", newStaff.staff_employment_status);
    data.append("file", newStaff.file);
    console.log("filename", newStaff.file);
    ...
    return { message: "Error creating Staffs. Please try again later." };
  }
}
...
const StaffForm = () => {
  ...
  const handleFileChange = (e) => {
    ...
    if (selectedFile && formData.staff_first_name && formData.staff_last_name) {
      ...
      setFormData((prevFormData) => ({ ...prevFormData, file: renamedFile }));
    } else {
